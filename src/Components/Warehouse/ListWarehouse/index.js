        ...
        props.warehouses.map((warehouse, i) => {
            return (
                <tr key={i}>
                    ...
                    <td>
                        <button onClick={() => props.handleUpdatewarehouse(warehouse.warehouseIdentifier.identifier)} className="delete">
                            <FontAwesomeIcon icon={faPencil}/>
                        </button>
                        <button onClick={() => props.handleDeletewarehouse(warehouse.warehouseIdentifier.identifier)} className="update">
